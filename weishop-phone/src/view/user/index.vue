<template>
  <div style="overflow-x: hidden;">
    <img class="user-poster" width="100%" height="150px" src="https://img.yzcdn.cn/public_files/2017/10/23/8690bb321356070e0b8c4404d087f8fd.png">
    <div class="userinfo">
      ...
      <div class="username" v-if="user&&user.name">
        <div>{{user.name}}</div>
        <div>销售额：0</div>
      </div>
