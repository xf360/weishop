<template>
  <a-layout>
    ...
    <a-layout class="fixlayout" :style="{left:contentleft}">
      <global-header class="fixheader" :style="{left:contentleft}" :menuData="menuData" :collapsed="collapsed" @toggleCollapse="toggleCollapse"/>
      <a-layout-content  class="fixcontent" :style="{backgroundColor:'#fff', left:contentleft, minHeight: minHeight, padding: '12px 12px 0'}">
        <slot></slot>
      </a-layout-content>
